...
use crate::{errors::XenovraStreamResult, repositories::storage_workers::StorageWorkersRepository};
...
impl<'d> StorageWorkersScheduler<'d> {
    ...
    pub async fn get_token(&self, storage_id: Uuid) -> XenovraStreamResult<String> {
        loop {
            // attempting
